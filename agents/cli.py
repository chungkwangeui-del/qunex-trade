...
{c('  │', Colors.PURPLE)}       {c('🛠️ Fixer', Colors.GREEN)}    {c('👨‍💻 Dev', Colors.BLUE)}      {c('🔬 Analyzer', Colors.YELLOW)}   {c('🔒 Security', Colors.RED)}    {c('│', Colors.PURPLE)}
...
{c('Expert Bots:', Colors.CYAN)}
    🛠️  Fixer Expert      - Fixes code errors and bugs
