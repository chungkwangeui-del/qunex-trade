...
class PennyStockCollector:
    ...
    def get_penny_stock_universe(self) -> List[str]:
        ...
        penny_stocks = [
            ...
            'DUTV', 'MINE', 'TSNP', 'TLSS', 'ABML', 'MNGG',
            'MYDX', 'PJET', 'HEMP', 'MCOA', 'GRCU', 'TRTC',
            'VATE', 'INND', 'VDRM', 'ECEZ', 'TAUG', 'PVDG',
            'CLSH', 'VPER', 'FDBL', 'FDCT', 'EVSV',

            # AI & 양자컴퓨팅 확장 (17개)
            'QBTS', 'DTST', 'CXAI', 'VTEX', 'SPIR', 'PATH',
            'NCNO', 'DOCN', 'RSKD', 'BRZE', 'AMBA', 'SMTC',
            'FORM', 'LITE', 'HIMX', 'UCTT', 'MKSI',

            # 바이오테크 임상시험 확장 (113개)
            'ABEO', 'ACRS', 'ADVM', 'AGIO', 'ALNA', 'ALNY',
            'ALPN', 'ANIK', 'APLS', 'APLT', 'APRE', 'ARAV',
            'ARCT', 'ARGX', 'ASMB', 'AUPH', 'AVEO', 'AVIR',
            'AVXL', 'AXSM', 'BDTX', 'BHVN', 'BIIB', 'BPMC',
            'BTAI', 'BYSI', 'CARA', 'CLDX', 'CMMB', 'CNTA',
            'CORT', 'CRNX', 'CRVS', 'CTMX', 'CVAC', 'CYCN',
            'CYTK', 'DAWN', 'DNLI', 'DSGN', 'DVAX', 'EIGR',
            'ELVN', 'EPIX', 'ERAS', 'ESPR', 'ETNB', 'EVLO',
            'FDMT', 'FOLD', 'FGEN', 'FMTX', 'GERN', 'GILD',
            'GLPG', 'GLUE', 'GOSS', 'HALO', 'HGEN', 'HRTX',
            'IGMS', 'IMAB', 'IMCR', 'IMGN', 'IMMP', 'INCY',
            'IONS', 'IOVA', 'IRWD', 'ITCI', 'JANX', 'KALA',
            'KALV', 'KRYS', 'KYMR', 'KZIA', 'LEGN', 'LIFE',
            'LIPO', 'LTRN', 'LUNA', 'LYEL', 'MCRB', 'MDGL',
            'MGNX', 'MNKD', 'MOLN', 'MRUS', 'MTEM', 'MYGN',
            'NARI', 'NBIX', 'NCNA', 'NKTX', 'NMTC', 'NTRA',
            'NUVB', 'NVTA', 'NWBO', 'OMER', 'ONCT', 'ONEM',
            'ORTX', 'OSPN', 'PCVX', 'PDFS', 'PGEN', 'PHAT',
            'PIRS', 'PRTK', 'PRVB', 'PTCT', 'PTGX',

            # Recent IPO 2023-2025 (16개)
            'RDDT', 'DASH', 'RBLX', 'DIDI', 'GRAB', 'ASTS',
            'BROS', 'FROG', 'GLBE', 'WYNN', 'ZS', 'CRWD',
            'DDOG', 'NET', 'SNOW', 'U',

            # EV & 그린에너지 확장 (18개)
            'PLUG', 'FCEL', 'BE', 'BLDP', 'CLNE', 'ENPH',
            'SEDG', 'RUN', 'CSIQ', 'JKS', 'SPWR', 'MAXN',
            'ARRY', 'NEP', 'AY', 'CWEN', 'BEPC', 'ORA',

            # 크립토/블록체인 확장 (4개)
            'WULF', 'CORZ', 'BTDR', 'DGHI',

            # SPAC & De-SPAC (15개)
            'PSFE', 'OPEN', 'GENI', 'DKNG', 'BODY', 'BARK',
            'TALK', 'ME', 'OUST', 'LAZR', 'VLDR', 'MKFG',
            'DM', 'NNDM', 'SLDP',

            # 대마초 & 환각제 확장 (9개)
            'HEXO', 'OGI', 'MSOS', 'YOLO', 'CMPS', 'ATAI',
            'MNMD', 'FTRP', 'NUMI',
 ]
