...
# Test stocks
test_stocks = ["AAPL", "MSFT", "NVDA", "GOOGL", "TSLA", "META", "AMZN", "AMD", "NFLX", "DIS"]
...
for symbol in test_stocks:
    try:
        ...
        price_data = model._fetch_historical_prices(symbol, "2023-01-01", "2024-11-11", polygon)
        ...
        results.append({"symbol": symbol, "score": score, "rating": rating})
